      ...
      for ($i=1; $i <= 10 ; $i++) { 
       ...
       ?>
                        ...
                        foreach ($tampil_id as $key) {
                         ?>
                        <?php  $a; ?>
                          <?php  $tahun_terakhir=$key->tahun; ?>
                          <?php  $bulan_terakhir=$key->bulan; ?>
                        ...
                        for ($i=0; $i < $panjang ; $i++) { ?>
                          ...
                          <?php 
                            ...
                            $bulan_baru=$bulan_terakhir + $jumlah_bulan;
                            $jumlah_bulan++;
                            ?>
                          <?php
                          $penjualan[$i][$j][$a] = $levelt[$i][$j][$a-1] + $trendt[$i][$j][$a-1];
                            ?>
                            <?php 
                            // echo $levelt_2[$m] = $n_alpha*$forecastt_2[$m-1]+(1-$n_alpha)*($levelt_2[$m-1]+$trendt_2[$m-1]);
                            $levelt[$i][$j][$a] = $n_alpha*($levelt_2[$i][$j][$a-1] + $trendt[$i][$j][$a-1])+(1-$n_alpha)*($levelt[$i][$j][$a-1]+$trendt[$i][$j][$a-1]);
                            ?>
                            <?php 
                            $trendt[$i][$j][$a] = $n_beta*($levelt_2[$i][$j][$a]-$levelt[$i][$j][$a-1])+(1-$n_beta)*$trendt[$i][$j][$a-1];
                            ?>
                            <?php 
                            $forecastt[$i][$j][$a] = $levelt[$i][$j][$a-1] + $trendt[$i][$j][$a-1];
                            ?>
